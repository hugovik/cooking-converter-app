...
//   //   'teaspoon-s': 32,
//   //   grams: 100,
//   //   'instant yeast': 2/3, // This means 1 cup of active dry = 2/3 cup instant
//   //   'compressed fresh baker\'s yeast': 2  // 1 cup active dry = 2 cups fresh
//   // },
//   // 'instant yeast': {
//   //   cup: 1,
//   //   'tablespoon-s': 16,
//   //   'teaspoon-s': 48,
//   //   grams: 150, // Updated weight - 1 cup of instant weighs more than active dry
//   //   'active dry yeast': 1.5 // 1 cup instant = 1.5 cups active dry (reciprocal of 2/3)
//   // },
//   // 'compressed fresh baker\'s yeast': {
//   //   cup: 1,
//   //   'tablespoon-s': 16,
//   //   'teaspoon-s': 48,
//   //   grams: 272,
//   //   'active dry yeast': 0.5, // 1 cup fresh = 0.5 cup active dry (reciprocal of 2)
//   //   'instant yeast': 0.33 // 1 cup fresh = 1/3 cup instant
//   // },
//   // Added flour conversions
//   'all-purpose flour': {
//     cup: 1,
...
// // Now define the hardcoded conversion chart with proper typing
// const YEAST_CONVERSION_CHART: YeastConversionChart = {
//   'active dry yeast': {
//     'instant yeast': {
//       'cup': {
...
//       },
//       'grams': {
//         'grams': 2.72  // Fresh yeast weighs 2.72x active dry
//       }
//     }
//   },
//   'instant yeast': {
...
//       },
//       'grams': {
//         'grams': 2.72  // Fresh yeast weighs 2.72x instant
//       }
//     }
//   },
//   'compressed fresh baker\'s yeast': {
...
//       },
//       'grams': {
//         'grams': 0.368  // Active dry weighs 0.368x fresh
//       }
//     },
//     'instant yeast': {
//       'cup': {
...
//       },
//       'grams': {
//         'grams': 0.368  // Instant weighs 0.368x fresh
//       }
//     }
//   }
// };
...
//     if (product.includes('yeast')) {
//       // Only include actual units, not yeast types
//       return Object.keys(CONVERSION_DATA[product]).filter(key => 
//         typeof CONVERSION_DATA[product][key] === 'number' && 
//         !key.includes('yeast') // This excludes yeast types from units
//       );
//     }
...
//     if (product.includes('yeast') && fromType && toType && fromType !== toType) {
//       // Check if we have a direct hardcoded conversion
//       if (YEAST_CONVERSION_CHART[fromType] && 
//           YEAST_CONVERSION_CHART[fromType][toType] && 
//           YEAST_CONVERSION_CHART[fromType][toType][fromUnit] && 
//           YEAST_CONVERSION_CHART[fromType][toType][fromUnit][toUnit]) {
...
//       if (fromUnit === 'grams' && toUnit !== 'grams') {
//         // Convert grams of fromType to cups of fromType
//         const fromTypeGramsPerCup = CONVERSION_DATA[fromType].grams as number;
//         const fromTypeCups = parsedInput / fromTypeGramsPerCup;
        
//         // Use our chart to convert cups of fromType to toUnit of toType
//         if (YEAST_CONVERSION_CHART[fromType][toType]['cup'][toUnit]) {
//           const conversionFactor = YEAST_CONVERSION_CHART[fromType][toType]['cup'][toUnit];
//           return fromTypeCups * conversionFactor;
//         }
//       }
...
//         // Convert fromUnit of fromType to cups of fromType
//         const fromTypeData = CONVERSION_DATA[fromType];
//         const fromUnitPerCup = fromTypeData[fromUnit] as number;
//         const fromTypeCups = parsedInput / fromUnitPerCup;
        
//         // Convert cups of fromType to grams of fromType
//         const fromTypeGramsPerCup = fromTypeData.grams as number;
//         const fromTypeGrams = fromTypeCups * fromTypeGramsPerCup;
        
//         // Convert grams of fromType to grams of toType
//         if (YEAST_CONVERSION_CHART[fromType][toType]['grams']['grams']) {
//           const gramConversionFactor = YEAST_CONVERSION_CHART[fromType][toType]['grams']['grams'];
//           return fromTypeGrams * gramConversionFactor;
//         }
//       }
...
//     const yeastData = CONVERSION_DATA[yeastType];
//     const unitPerCup = yeastData[unit];
    
//     if (typeof unitPerCup !== 'number' || unitPerCup <= 0) return null;
    
//     return value / unitPerCup;
//   };
